...
eps = np.finfo(
    float).eps  # me dê o menor número positivo possível que o tipo de dados float pode representar na minha máquina”.
from numpy import log2 as log


def carrega_gera_caracteristicas(logG, metricas_ger, nome_pasta_csv, media_sublogs,dlt,lista_ativ_media_final):
    type(logG)
